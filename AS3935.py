...
class AS3935:
    ...
    def __init__(self,  i2c, addr=0x00):
        self._addr = addr
        self._i2c = i2c
    ...
    def set_byte(self, register, value):
        ...
        """
        try:
            self._i2c.writeto_mem(self._addr, register, value)
    ...
    def read_data(self):
        ...
        """
        try:
            self.registers = self._i2c.readfrom_mem(self._addr, 0, 9)
            self.registers1 = self._i2c.readfrom_mem(self._addr, 0x3a, 4)
        except Exception as e:
